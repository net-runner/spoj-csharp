...
public class Czas24h
{
    ...
    public int Godzina
    {
        ...
        set
        {
            ...
            liczbaSekund -= Godzina * 60 * 60;
            liczbaSekund += value * 60 * 60;
        }
    ...
    public Czas24h(int godzina, int minuta, int sekunda)
    {
        ...
        if (godzina < 0 || godzina > 23) throw new ArgumentException();
        if (minuta < 0 || minuta > 59 || sekunda < 0 || sekunda > 59) throw new ArgumentException();
